...
V_p(3913,3865,0.0007,1/262,0.17) #Lavere. Passer fint med IV-plot

#Strike 3900
data1$mar.22.2021$put[127,]
V_p(3913,3900,0.0007,1/262,0.17) #Lavere. Passer fint med IV-plot

#Strik 3950
data1$mar.22.2021$put[137,]
V_p(3913,3950,0.0007,1/262,0.17) #Lavere. Passer fint med IV-plot

#Call
#Strike 3900
data1$mar.22.2021$call[58,]
V_c(3913,3900,0.0007,1/262,0.17) #Passer fint med IV-plot

#Strike 3950
data1$mar.22.2021$call[68,]
V_c(3913,3950,0.0007,1/262,0.17) #Passer fint med IV-plot

#Strike 4000
data1$mar.22.2021$call[78,]
V_c(3913,4000,0.0007,1/262,0.17) #Passer fint med IV-plot
